...
- **Title IPC sync** — viewer sends `title` message (with `windowTitle` and `titleEmoji`) to the worker when the title preset changes, ensuring worker notifications use the correct title and emoji.
